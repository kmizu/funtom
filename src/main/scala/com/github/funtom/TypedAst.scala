...
import com.github.funtom.Type.{TDynamic, TRecord, TScheme, TVariable}
...
object TypedAst {
  ...
  case class PhantomId(type_ : Type, location: Location, name: String) extends TypedNode
  ...
  case class PhantomCall(type_ : Type, location: Location, func: PhantomId, params: List[TypedNode]) extends TypedNode
