...
import com.github.funtom.Type.TVariable
...
object Ast {
  ...
  case class PhantomId(location: Location, name: String) extends Node
  ...
  case class PhantomCall(location: Location, func: Ast.PhantomId, params: List[Ast.Node]) extends Node
